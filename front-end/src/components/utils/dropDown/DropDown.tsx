...
const DropDown: React.FC<DropDownProps> = ({ menuItems, title }) => {
  ...
  return (
    <div ref={ref} className="relative inline-block text-left">
      ...
      {open && (
        <div className="absolute right-0 mt-1 w-48 origin-top-right border border-solid border-Green200 rounded-md bg-white shadow-lg ring-1 ring-black/5 shadow-Green400">
          <div className="py-1">
            {menuItems.map((item) =>
              item.href ? (
                <a
